        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-white/10 dark:border-white/10 light:border-gray-200">
          ...
          <div className="flex items-center space-x-3">
            <button
              ...
              title="Print atau simpan CV sebagai PDF"
            >
            ...
            <Link
              to="/contact"
              className="inline-flex items-center space-x-1.5 px-4 py-2.5 rounded-full bg-white/5 border border-white/10 hover:border-lime/40 text-xs font-mono text-gray-300 hover:text-lime transition-colors"
            >
              <span>Hire Me</span>
